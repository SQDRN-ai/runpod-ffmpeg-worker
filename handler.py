...
TMP_HB_ASS = "/tmp/happy_birthday_overlay.ass"  # ✅ NEW
...
def handler(event):
    try:
        ...
        hb_cfg = render.get("happy_birthday_overlay", None)  # ✅ NEW
        ...
        # ✅ NEW: HAPPY BIRTHDAY overlay (above the name)
        ...
        if isinstance(hb_cfg, dict):
            ...
            if hb_text:
                # default position: above the name if name has y, else ~40% height
                name_y = None
        ...
        return {
            ...
            "happy_birthday_used": happy_birthday_used,  # ✅ NEW
